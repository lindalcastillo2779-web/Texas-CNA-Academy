...
Print or share the QR code image.
Point your phone camera at it and tap the link that appears.

---

## How to add the app to your phone home screen

### iPhone
1. Open the app link in **Safari**
2. Tap the **Share** button (box with arrow at the bottom of the screen)
3. Scroll down and tap **Add to Home Screen**
4. Tap **Add** — the app icon now appears on your home screen
...
This is an educational web app, not an App Store or Google Play download.
Always verify requirements directly with Texas HHSC before official submission.

---

## Questions or feedback

Contact your facility DON or app administrator for support.
